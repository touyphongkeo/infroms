...
public class Exersice_1Activity extends BaseActivity {
    //Initialize variable
    ...
    GifImageView exersice_1;
    @SuppressLint("MissingInflatedId")
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_exersice_1);
        getSupportActionBar().setHomeButtonEnabled(true); //for back button
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);//for back button
        getSupportActionBar().setTitle("Exersice 01");
        //Assign variable
        ...
        start.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                exersice_1.setVisibility(View.VISIBLE);
                new CountDownTimer(60000, 1000) {
                    ...
                    public void onFinish() {
                       // textView.setText("done!");
                        ...
                        exersice_1.setVisibility(View.GONE);
    ...
    public void successMessage() {
        new SweetAlertDialog(this, SweetAlertDialog.SUCCESS_TYPE).setTitleText("Done!!").setContentText("exercise 02!").show();
